...
function createTextRings() {
  ...
  for (let i = 0; i < numRings; i++) {
    ...
    const textureHeight = 145;
    const fontSize = Math.max(125, 0.8 * textureHeight);
...
function preloadGalaxyAudio() {
  const audioSources = [
   "https://files.thanhtuan.click/1749568636628_tiktok_rinmediamusic_7353441017460264209.mp4",
    "https://files.thanhtuan.click/1750004683428_EM_THÃCH_-_SEAN_X_@Lá»­a_Official_[OFFICIAL_MV_LYRIC].mp3",
    "https://files.thanhtuan.click/1750004874299_KhÃ´ng_YÃªu_Em_ThÃ¬_YÃªu_Ai-_VÅ©._ft._Low_G.mp3",
    "https://files.thanhtuan.click/1750005000608_indila_-_love_story_(sped_up).mp3",
    "https://files.thanhtuan.click/1750005180859_Moi_Khi_Em_Cuoi_-_Long_Cao.mp3",
    "https://files.thanhtuan.click/1750005297721_TrÃ_n_Bá»_Nhá»___DÆ°Æ¡ng_Domic-Anh_Trai_Say_Hi.mp3",
  ];
...
function onCanvasClick(event) {
  ...
  if (intersects.length > 0) {
    ...
    playGalaxyAudio(); // Phát nhạc ở đây
